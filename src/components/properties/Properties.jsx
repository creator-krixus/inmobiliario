        ...
        <div className="fluid mb-3 mt-3">
            <div className="row align-items-center d-flex flex-wrap flex-fill">
                <div className="col mt-1 mb-1">
                    ...
                    <button type="button" className="btn btn-warning">Apartamentos</button>
                </div>
                <div className="col mt-1 mb-1">
                    ...
                    <button type="button" className="btn btn-warning">Lotes</button>
                </div>
                <div className="col mt-1 mb-1">
                    ...
                    <button type="button" className="btn btn-warning">Casas</button>
                </div>
            </div>
